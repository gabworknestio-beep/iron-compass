...
import com.ironpath.gear.CombatStyle;
...
import com.ironpath.gear.GearUpgrade;
...
public final class GearPathPanel extends JPanel
{
    ...
    private void confirmReset()
    {
        int answer = JOptionPane.showConfirmDialog(this,
            ...
            "Reset IronPath gear choices", JOptionPane.OK_CANCEL_OPTION, JOptionPane.WARNING_MESSAGE);
    ...
    private static String priorityReason(GearEvaluation evaluation)
    {
        ...
        if (evaluation.isSelectedGoal())
            return "Selected by you; IronPath will route the first unfinished dependency to Overview.";
